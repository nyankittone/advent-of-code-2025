# WHat is this?
This is a single binary that solves problems from Advent of Code 2025. It is a Rust binary taht,
...
other than the standard library. THis might be problematic in the case of Rust, since it had a
